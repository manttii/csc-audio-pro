...
const offices = [
  {
    ...
    city: 'Leicester',
    address: '48 Boston Road\nLeicester, LE41AA, United Kingdom',
    phone: 'contact@cscaudio.co.uk',
    email: 'contact@cscaudio.co.uk',
    accent: 'red' as const,
    tag: 'HQ',
  },
  {
    region: 'Europe',
    city: 'Fürth, Germany',
    address: 'Schwabacher Straße 512\nFürth, Germany',
    phone: 'daniel@cscaudio.co.uk',
    email: 'daniel@cscaudio.co.uk',
  ...
  },
  {
    ...
    phone: 'info@cscaudio.co.uk',
    email: 'info@cscaudio.co.uk',
    accent: 'red' as const,
    tag: 'APAC',
  },
]
